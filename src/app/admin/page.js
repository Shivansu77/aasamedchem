  ...
  return (
    <div className="p-6 sm:p-10 max-w-7xl w-full mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <Link href="/admin/users" className="bg-white border border-slate-200 p-6 rounded-2xl space-y-3 shadow-sm hover:shadow-md hover:border-brand-300 transition-all group">
